...
public class MainActivity extends AppCompatActivity {
    ...
    public void izinIste() {//Fotoğrafları hafızaya yazmak için gerçek zamanlı izin alma
        try {
            ...
            if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    requestPermissions(permissionRequested, PERMISSION_WRITE_EXTERNAL_STORAGE);
                }
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    return mainFragment;
                case 1:
                    DigerFragment digerFragment = new DigerFragment();
                    return digerFragment;
                default:
                    return null;
            }
        }
